<template>
 <div>
  <v-navigation-drawer app v-model="drawer" relative temporary>
   <v-list
    class="ml-2" 
    nav>
  ...
  <v-app-bar app color="blue darken-1" dark src="@/assets/technology.jpeg">
   ...
   <v-toolbar-items class="hidden-xs-only">
    ...
    <v-btn
     ...
     :href="website.href"
    >
     <v-icon left large>{{ website.icon }} </v-icon>
     {{ website.text }}
    </v-btn>
   </v-toolbar-items>
  </v-app-bar>
