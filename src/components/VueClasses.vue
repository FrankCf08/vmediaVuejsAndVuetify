<template>
  <div>
    ...
    <div v-show="visible" id="class19">
      <Class19
        :duties="duties"></Class19>
    </div>
    <div v-show="visible" id="class20">
      <Class20/>
    </div>
    ...
    <div v-show="visible" id="class26">
      <Class26/>
    </div>
    <div v-show="visible" id="class27">
      <Class27/>
    </div>
    <div v-show="visible" id="class28">
      <Class28/>
    </div>
    ...
    <div v-show="visible" id="class34">
      <Class34/>
    </div>
    <div v-show="visible" id="class35">
      <Class35/>
		</div>
    <div v-show="visible" id="class36">
      <Class36/>
		</div>
  </div>
</template>
...
import Class29 from "../classes/class29"
import Class30 from "../classes/class30"
import Class31 from "../classes/class31"
import Class34 from "../classes/class34"
import Class35 from "../classes/class35"
import Class35 from "../classes/class36"
